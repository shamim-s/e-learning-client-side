...
const Home = () => {
  ...
  return (
    <div>
      <section className="lg:mb-12 md:mb-8 mb-4">
        <div className="hero min-h-screen bg-base-200" style={myStyle}>
          <div className="hero-content flex-col lg:flex-row-reverse lg:w-full md:w-full w-96">
      ...
      <section className="lg:mb-4 md:mb-4 mb-8">
        <h1 className="lg:text-3xl font-bold text-center md:text-3xl mb-2">
        ...
        <div className="lg:p-12">
          ...
          <p className="text-center mt-5">
            <Link
              className="btn border-0 hover:bg-rose-800 hover:border-0"
              to={"/courses"}
            >
              View Courses
            </Link>
